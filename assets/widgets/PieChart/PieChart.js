...
Dashing.PieChart = (function(superClass) {
  ...
  PieChart.prototype.ready = function() {
    ...
    return this.myChart = new Chart(this.ctx).Pie(this.myData, $.extend({
      responsive: true,
      segmentShowStroke: true
    }, this.get('options')));
  };

  PieChart.prototype.onData = function(data) {
    var i, j, ref;
